...
export function populatePartnerCard(selectedCountry) {
    ...
    biPartner.classList.add("card-title", "card-title-fixed", "partner-select", "h2");
    ...
    if (selectCountryData) {
        selectCountryData.forEach((entry) => {
            ...
            link.href = entry.linkAgreement ? `${entry.linkAgreement}` : `${entry.sources}`;
            link.target = "_blank";
            ...
            if (entry["Areas of Cooperation - Categories"] !== "No data") {
                console.log('Entry of areas of cooperation', entry["Areas of Cooperation - Categories"])
                ...
                entry["Areas of Cooperation - Categories"].forEach((area) => {
                    ...
                    tag.classList.add("btn", "btn-outline-dark", "aresCoop", "ms-1", "me-1");
                    ...
                    // Add icon
                    const iconPath = `/assets/img/icons/${area
                        .toLowerCase()
            ...
            console.log('Entry of Economic and Investment Trend', entry["Economic and Investment Trend"])
            if (entry["Economic and Investment Trend"] !== "No data") {
                ...
                trendButton.classList.add("btn", "btn-sm", "d-flex", "align-items-center", "justify-content-between");
                ...
                if (entry["Number of Flagship Green Projects"] !== "No data") {
                    ...
                    flagshipProjects.innerHTML = `<span class="fw-bold flagshipProjects">Number of Flagship Green Projects:</span> ${entry["Number of Flagship Green Projects"]}`;
    ...
    const tooltipTriggerList = [].slice.call(partnerDiv.querySelectorAll('[data-bs-toggle="tooltip"]'));
